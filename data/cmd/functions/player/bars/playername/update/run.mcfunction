...
#Team 1
execute if score @s team matches 1 run data merge block 0 0 0 {Text1:'{"nbt":"update.name","storage":"cmd:var","color":"#0000FF","bold":"true"}'}

#Team 2
execute if score @s team matches 2 run data merge block 0 0 0 {Text1:'{"nbt":"update.name","storage":"cmd:var","color":"#FF0000","bold":"true"}'}

...
#get control
execute store result score get.offset var run data get storage cmd:controls/display statIcon.armor.offset

#COLOR
#cycle
data modify storage cmd:process/array/cycleto array set from storage cmd:controls/armor statIdentities.armor
...
#multiply
scoreboard players set get.mult var 5

...
#add win
execute if score winteam GAME matches 1 run scoreboard players add wins_blue 1
execute if score winteam GAME matches 2 run scoreboard players add wins_red 1
...
#RESETS
scoreboard players reset winningteam var

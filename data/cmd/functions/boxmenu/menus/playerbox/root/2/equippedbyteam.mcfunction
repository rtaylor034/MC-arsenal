...
#sign parse
data merge block 0 0 0 {Text1:'[{"text":"Equipped by ","color":"dark_red","bold":true,"italic":false},{"selector":"@a[tag=_equip-source]","separator":" and ","color":"red","bold":true,"italic":false}]'}
